...
print(plateau.deplace_personnage(le_plateau, (0,0), plateau.OUEST))
...
def test_contient_fantome():
    le_plateau = plateau.init()
    matrice.set_valeur(le_plateau, 4, 3, plateau.FANTOME)
...
def test_fabrique_le_calque():
    ...
    assert le_calque == matrice.charge_matrice("/home/iut45/Etudiants/o22301884/init-dev/initdev_git/initdev2023/TP12 plus court chemin dans une grille-20231215/labyrinthe/calque1_pour_test.csv")
test_fabrique_le_calque()
